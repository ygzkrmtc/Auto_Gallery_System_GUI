...
def car_list_screen():
    ...
    for i in cars:
        ...
        m=0
        for j in values:
            tk.Label(car_list_window,text=j).grid(row=k+2, column=m)
            m+=1
        k+=1
...
def advertised_car_screen():
    ...
    k=0
    for i in advertised_cars:
        values=i.values()
        m=0
        for j in values:
            tk.Label(advertised_car_window,text=j).grid(row=k+2, column=m)
            m+=1
        k+=1
...
def add_car_screen():
    ...
    def make_dict(brand, model, year, engine, hp, km, color):
        car_informations = {"brand": brand, "model": model
            , "year": year, "engine": engine
            , "hp": hp, "km": km, "color": color}

        cars.append(car_informations)
        messagebox.showinfo("showinfo", "Car Added")
...
def advertise_car_screen():
    if "user_menu_window" in globals():
        user_menu_window.destroy()
    global advertise_car_window
    advertise_car_window = tk.Tk()
    advertise_car_window.title("Auto Gallery Program")
    advertise_car_window.geometry("450x580+400+50")
    advertise_car_window.resizable(False, False)

    label = tk.Label(advertise_car_window, text="Advertise Car", fg="black", bg="grey", font="Times 25 bold")
    label.pack(fill=tk.X)
    label1 = tk.Label(advertise_car_window, text="Brand:", fg="black", font="Times 18 bold")
    label1.place(x=20, y=60)
    label2 = tk.Label(advertise_car_window, text="Model:", fg="black", font="Times 18 bold")
    label2.place(x=20, y=110)
    label3 = tk.Label(advertise_car_window, text="Year:", fg="black", font="Times 18 bold")
    label3.place(x=20, y=160)
    label4 = tk.Label(advertise_car_window, text="Engine:", fg="black", font="Times 18 bold")
    label4.place(x=20, y=210)
    label5 = tk.Label(advertise_car_window, text="HP:", fg="black", font="Times 18 bold")
    label5.place(x=20, y=260)
    label6 = tk.Label(advertise_car_window, text="KM:", fg="black", font="Times 18 bold")
    label6.place(x=20, y=310)
    label7 = tk.Label(advertise_car_window, text="Color:", fg="black", font="Times 18 bold")
    label7.place(x=20, y=360)
    label8 = tk.Label(advertise_car_window, text="Damage:", fg="black", font="Times 18 bold")
    label8.place(x=20, y=410)
    label9 = tk.Label(advertise_car_window, text="Price:", fg="black", font="Times 18 bold")
    label9.place(x=20, y=460)
    ...
    e1 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e1.place(x=120, y=60)
    brand=e1

    e2 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e2.place(x=120, y=110)
    model=e2
    e3 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e3.place(x=120, y=160)
    year=e3
    e4 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e4.place(x=120, y=210)
    engine=e4
    e5 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e5.place(x=120, y=260)
    hp = e5
    e6 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e6.place(x=120, y=310)
    km = e6
    e7 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e7.place(x=120, y=360)
    color = e7
    e8 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e8.place(x=120, y=410)
    damage = e8
    e9 = tk.Entry(advertise_car_window,  font="Times 20", bg="dark grey")
    e9.place(x=120, y=460)
    price = e9

    b1 = tk.Button(advertise_car_window, text="Advertise", font="Times 20 bold", bg="orange", command= lambda: give_advertise(brand.get(), model.get(),
                                                                                                      year.get(),engine.get(),
                                                                                                      hp.get(),km.get(),color.get(), damage.get(), price.get()))
    b1.place(x=20, y=510, width=195)
    b2 = tk.Button(advertise_car_window, text="Back", font="Times 20 bold", bg="orange", command=user_menu_screen)
    b2.place(x=235, y=510, width=195)

    advertise_car_window.mainloop()




def give_advertise(brand, model, year, engine, hp, km, color, damage, price):

    advertised_car_informations  = {"brand": brand, "model": model
                                         , "year": year, "engine": engine
                                         , "hp": hp,"km":km, "color": color
                                         , "damage": damage, "price": price}
    advertised_cars.append(advertised_car_informations)
    messagebox.showinfo("showinfo", "Car Added to Advertised List")
    ...
    print(advertised_cars)


def admin_entrance(entrance_username, entrance_password):
    if entrance_username == username and entrance_password == password:
        user_menu_screen()
